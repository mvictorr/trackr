  ...
  LOOP AT <gt_data> ASSIGNING <gl_line>.
    IF Lv_count <> 0.
      ...
      IF <gl_data> <> ''.
        ...
        ASSIGN COMPONENT 9 OF STRUCTURE <gl_line> TO <gl_data>.
        ls_emp_prj-comments = <gl_data>.
        IF lv_upload_toggle = 1.
...
FORM clear_data.
  ...
  CLEAR LV_exists.
  CLEAR lv_existing.
  CLEAR lv_total_teams.
  CLEAR lv_existing_teams.
  CLEAR lv_total_members.
  CLEAR lv_existing_members.
  CLEAR lv_total_projects.
  CLEAR lv_existing_projects.
  CLEAR lv_upload_toggle.
  CLEAR ls_member.
  CLEAR Lv_count.
  CLEAR lv_manager.
  CLEAR lv_project.
  ...
  CLEAR LV_total.
  CLEAR lv_id.
  CLEAR Lv_last_user_id.
  CLEAR Lv_last_proj_id.
  CLEAR Lv_day_sum.
  CLEAR LS_Project.
  CLEAR LS_User.
  CLEAR ls_team.
  ...
  CLEAR LT_Employee.
  CLEAR ls_Employee_check.
  CLEAR LT_Employee_wid.
  CLEAR LV_last_user.
  CLEAR Lt_Data.
  CLEAR xline.
  CLEAR t_file.
  CLEAR lv_headerxstring.
  CLEAR lv_filelength.
  CLEAR LT_Project.
  CLEAR ls_projects.
  CLEAR ls_projects_check.
  CLEAR LT_Project_wid.
ENDFORM.
